...
SITE_CONFIGS = {
    'Name': 'myblog',  # 站点名称
    'Title': 'python小白在此',  # 站点标题

    # 站点底部footer配置
    'Footer': {
        'Email': '1304368100@qq.com',  # 邮箱
        'Weibo': 'https://weibo.com/u/5837502747?is_all=1',  # 新浪微博
        'Music': 'https://music.163.com/#/user/home?id=564328149',  # 音乐地址
        'GitHub': 'https://github.com/zty1304368100',  # GitHub
    ...
    'Music': {
        ...
        'home': 'https://music.163.com/#/user/home?id=564328149',  # 用户主页，点击会跳转到你的主页
        'server': 'netease',    # netease（网易云音乐）tencent（QQ音乐） xiami（虾米） kugou（酷狗）
        'mode': 'circulation',  # random （随机） single （单曲） circulation （列表循环） order （列表）
        'type': 'playlist',     # song （单曲） album （专辑） playlist （歌单） search （搜索）
        'id': '564328149',  # 播放歌单id，获取方法自行百度。比如我的id就是链接后面的id，https://music.163.com/#/playlist?id=2700450552
